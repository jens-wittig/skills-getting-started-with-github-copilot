...
activities = {
    "Basketball": {
        "description": "Team sport focusing on ball handling, shooting, and court strategy",
    ...
    "Art Studio": {
        "description": "Create paintings, drawings, and sculptures with professional guidance",
